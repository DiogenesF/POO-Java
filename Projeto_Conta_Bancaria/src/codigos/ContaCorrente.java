...
/**
 * Classe Conta Corrente é utilizada para a criação de uma Conta Corrente e em seguinte podendo
 * efetuar um deposito, saque ou efetuar uma transferencia 
 * para uma conta a escolha do Usuario.
 * <p>
...
public class ContaCorrente extends Conta {
	/**
	 * Construtor para a Conta Corrente que recebe como parametro o Nome
	 * do Usuario, CPF, o Saldo, a Senha da conta, Data de Nascimento e 
	 * o tipo de conta.
	 * OBS.: É utilizado o super para a chamada do construtor da Classe
	 * Conta.
	 * 
	...
	/**
	 * Contrutor para a Conta Corrente onde so recebe um objeto da Classe
	 * Cliente e utiliza o super para acessar os métodos dessa classe
	 * 
